...
if   var_units in ['degC','degrees Celsius']:   info_unit_txt = '$^\circ$C'; colorbar_unit_txt = '$^\circ$C';                html_unit_txt = '&#176C';  bokeh_unit_txt = '\u00B0C'
elif var_units == 'mm/day':                     info_unit_txt = 'mm/day';    colorbar_unit_txt = 'mm day$^{-1}$';            html_unit_txt = 'mm/day';  bokeh_unit_txt = '\u207B\u00B9'
elif var_units == 'permil (relative to VSMOW)': info_unit_txt = 'permil';    colorbar_unit_txt = 'permil relative to VSMOW'; html_unit_txt = 'permil';  bokeh_unit_txt = 'permil'
else:                                           info_unit_txt = var_units;   colorbar_unit_txt = var_units;                  html_unit_txt = var_units; bokeh_unit_txt = var_units

# Set some text
colorbar_txt    = quantity_txt+' '+variable_name+' ('+colorbar_unit_txt+')'
title_txt_bokeh = quantity_txt+' '+variable_name+' ('+bokeh_unit_txt+')'
...
if make_regional_ts:
    ...
    for j in range(n_regions):
        #
        # Make an interactive time series with bokeh
        var_mean_to_plot       = var_regional_mean[:,:,j]
        var_lowerbound_to_plot = var_regional_lowerbound[:,:,j]
        var_upperbound_to_plot = var_regional_upperbound[:,:,j]
