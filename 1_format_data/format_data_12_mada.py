...
#%% LOAD DATA
# Note: data can be downloaded at: https://www.ncei.noaa.gov/access/paleo-search/study/10435

print('=== Processing MADA ===')
data_dir = '/projects/pd_lab/data/paleoclimate_reconstructions/drought_atlases/'

# Load data
data_xarray = xr.open_dataset(data_dir+'MADApdsi.nc',decode_times=False)
...
data_xarray_output = xr.Dataset(
    ...
    attrs={
        'dataset_name':      'Monsoon Asia Drought Atlas',
        'dataset_source_url':'https://www.ncei.noaa.gov/access/paleo-search/study/10435',
    },
)
...
data_xarray_output.to_netcdf(output_dir+'mada_v1_0_0_pdsi_jja.nc')
